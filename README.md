...
| [Prediction-Market Exchange](projects/prediction-market-exchange/) · [live](https://prediction-market-exchange.onrender.com) · [code](https://github.com/Duyanh090205/prediction-market-exchange) | A working exchange: central limit order book, margin engine, atomic settlement | ~15.6k lines, **103 unit tests**, price–time priority matching |
